...
/**
 * Exception send on the client of the service when a problem occurred during a request process for the actor.
 *
 * @see MediaException
 * @see fr.nicolasgille.medialibrary.controllers.common.person.ActorController
