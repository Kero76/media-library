...
/**
 * Exception send on the client of the service when a problem occurred during a request process for the cartoon.
 *
 * @see MediaException
 * @see fr.nicolasgille.medialibrary.controllers.video.CartoonController
 * @author Nicolas GILLE
 * @since Media-Library 0.3
 * @version 2.0
 */
public class CartoonException extends MediaException {
