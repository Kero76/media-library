...
public class Cartoon extends Video {
     ...
     * @param originalTitle Original title of the cartoon.
     * @param synopsis Synopsis of the cartoon.
     * @param directors List of all directors of the cartoon.
     * @param producers List of all producers of the cartoon.
     * @param genres List of all genres for the cartoon.
     * @param supports Supports present for the cartoon.
     * @param languagesSpoken List of languages spoken available on cartoon.
     * @param subtitles List of subtitle languages available on cartoon.
     * @param releaseDate Date of release of the cartoon.
     * @param runtime Duration of the cartoon in minute.
     *
     * @version 1.1
     * @since 1.0
     */
     ...
     *
     * @param cartoon New content of each attribute of this.
     *
     * @version 1.1
     * @since 1.0
     */
     ...
     *
     * @return A short description of the content of the cartoon's attribute.
     *
     * @version 2.0
     * @since 1.0
     */
