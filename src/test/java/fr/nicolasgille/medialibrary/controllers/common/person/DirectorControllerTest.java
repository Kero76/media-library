...
public class DirectorControllerTest {
    ...
    public void getAll() {
        ...
        ResponseEntity<List> responseEntity =
                this.restTemplate.getForEntity(REST_SERVICE_URI + "/directors/", List.class);
    ...
    public void getOneDirector() {
        ...
        ResponseEntity<Director> responseEntity = this.restTemplate.getForEntity(
                REST_SERVICE_URI + "/search/directors?fname=" + fnameExpected + "&lname=" + lnameExpected,
                Director.class);
