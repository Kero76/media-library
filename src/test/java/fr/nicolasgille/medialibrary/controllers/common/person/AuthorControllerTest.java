...
/**
 * Unit class test used to test AuthorController class.
 *
...
public class AuthorControllerTest {
    ...
    public void getAll() {
        ...
        ResponseEntity<List> responseEntity = this.restTemplate.getForEntity(REST_SERVICE_URI + "/authors/", List.class);
